...
export function PredictorSemesterCard({
  semester,
  originalSgpa,
  predictedSgpa,
  isNew,
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm text-muted-foreground">
              <span>
                SGPA:{" "}
                <span
                  className={`font-semibold ${sgpaDiff !== null && sgpaDiff > 0 ? "text-green-600" : sgpaDiff !== null && sgpaDiff < 0 ? "text-red-600" : "text-foreground"}`}
                >
            ...
            <Table>
              ...
              <TableBody>
                {courses.map((course) => {
                  ...
                  return (
                    <TableRow key={course.id} className={isNewCourse ? "bg-primary/5" : ""}>
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <div>
                      ...
                      <TableCell className="text-center">
                        <Select
                          value={course.grade}
                          onValueChange={(value) => onEditCourse(course.id, { grade: value as Grade })}
                        >
